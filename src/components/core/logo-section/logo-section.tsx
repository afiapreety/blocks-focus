  ...
  return (
    <div className="relative h-16 w-full">
      <img
        ...
        alt="logo"
        className={`absolute left-4 top-2 h-12 w-auto max-w-full duration-300 ${
      ...
      <img
        ...
        alt="smallLogo"
        className={`absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 h-8 w-8 duration-300 ${
